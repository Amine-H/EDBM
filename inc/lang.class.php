	...
	public static function init(){
		...
		if($lang == 'en'){
			...
			Lang::$dictionary = array('EDBM_welcome'=>'mar7aban bikom!',
								...
								'add_parameter'=>'إضافة عامل',
								'function_name'=>'اسم الوظيفة',//fonction.php
								'create_function'=>'خلق وظيفة',
								'parameters'=>'العوامل',
								'return_type'=>'نوع الإرجاع',
								'procedure_name'=>'اسم الإجراء',//procedure.php
								'create_procedure'=>'إنشاء إجراء',
								'direction'=>'الاتجاه',
								'size'=>'الحجم',
								'code'=>'التعليمات البرمجية',
								'name'=>'الاسم',
								'type'=>'النوع',
								'connection'=>'اتصال',//login.php
								'user'=>'المستخدم',
								'password'=>'كلمة المرور',
								'connect'=>'اتصل',
								'add_data'=>'إضافة بيانات',//table.php
								'no_data'=>'لا تزال فارغة',
								'logout'=>'تسجيل الخروج',
								'home'=>'الصفحة الرئيسية',
								'console'=>'وحدة التحكم',
								'execute'=>'تنفيذ',
								'insert_code'=>'كتابة التعليمات البرمجية',
								'code_executed'=>'تنفيذ التعليمات البرمجية بنجاح',
								'add_row'=>'إضافة صف واحد');//tableInsert.php
       	}
	}
